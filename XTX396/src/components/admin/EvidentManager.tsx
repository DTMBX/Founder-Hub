...
const satellites: SatelliteStatus[] = [
  {
    ...
    liveUrl: 'https://evident.icu/apps/civics-hierarchy/',
    repoPath: 'apps/civics-hierarchy',
    basePath: '/apps/civics-hierarchy/',
    accentColor: 'blue',
  ...
  },
  {
    ...
    liveUrl: 'https://evident.icu/apps/essential-goods/',
    repoPath: 'apps/essential-goods-ledg',
    basePath: '/apps/essential-goods/',
    accentColor: 'teal',
  ...
  },
  {
    ...
    liveUrl: 'https://evident.icu/apps/geneva-bible-study/',
    repoPath: 'apps/geneva-bible-study-t',
    basePath: '/apps/geneva-bible-study/',
    accentColor: 'amber',
