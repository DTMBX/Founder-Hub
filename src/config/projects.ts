...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'Tillerstead',
    slug: 'tillerstead',
    summary: 'Home improvement and land stewardship — TCNA-compliant tile installation, South Jersey. NJ HIC #13VH10808800.',
    status: 'live',
  ...
  },
  {
    ...
    summary: 'DOJ Epstein case documents — e-discovery demo and public-service archive powered by Evident processing engines.',
    status: 'live',
  ...
  },
  {
    ...
    summary: 'Economic analysis — commodity pricing, supply chain metrics, and cost-of-living indicators.',
    status: 'live',
  ...
  },
  {
    ...
    summary: 'Offline-capable Scripture study — full-text search, marginal notes, and reading plans.',
    status: 'live',
  ...
  },
  {
    ...
    summary: 'Evidence-based maternity and newborn care information with sourced claims and consent tracking.',
    status: 'live',
