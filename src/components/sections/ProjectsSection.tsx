...
const ECOSYSTEM_DEFAULTS: Project[] = [
  {
    ...
    description: 'Central platform coordinating civic tech, legal tools, and accountability systems across the xtx396.com ecosystem.',
    tags: ['civic-tech', 'accountability', 'platform'],
    techStack: ['React', 'TypeScript', 'Vite'],
    links: [{ label: 'Live', url: 'https://www.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    links: [{ label: 'Live', url: 'https://civics.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    techStack: ['React', 'TypeScript'],
    links: [{ label: 'Live', url: 'https://library.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    techStack: ['React', 'TypeScript'],
    links: [{ label: 'Live', url: 'https://consent.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    techStack: ['React', 'TypeScript'],
    links: [{ label: 'Live', url: 'https://ledger.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    techStack: ['React', 'TypeScript'],
    links: [{ label: 'Live', url: 'https://bible.xtx396.com', type: 'demo' }],
  ...
  },
  {
    ...
    links: [{ label: 'Live', url: 'https://contractor.xtx396.com', type: 'demo' }],
